class AddNewProductModel {
  ...
  late final List<dynamic> relatedIds;
  ...
  AddNewProductModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    slug = json['slug'];
    ...
    relatedIds = List.castFrom<dynamic, dynamic>(json['related_ids']);
...
class Address {
  ...
  Map<String, dynamic> toJson() {
    final _data = <String, dynamic>{};
    _data['street_1'] = street_1;
    _data['street_2'] = street_2;
    _data['city'] = city;
    _data['zip'] = zip;
